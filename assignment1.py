...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 18 11:51:16 2020
...
#%%
def problem1_3(n):
    """ Adds up the numbers 1 through to n and prints out the result."""
    my_sum = 0
...
#%%
def problem1_5(age):
    """ Assesses the person's age and gives them the appropriate drink."""
    if age < 7:
...
#%%
def problem1_6():
    """ Prints the odd numbers from 1 through to 100."""
...
#%%
def problem1_7():
    """ Computes the area of a trapezoid from user input dimensions."""
