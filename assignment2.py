...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 24 11:07:25 2020
...
#%%      
def problem2_1():
    """ Composes a list of numbers between 20 and 30 and prints section of list"""
...
def problem2_3(ne):
    """ Prints name of the state and the number of letters in state's name."""
    for i in range(0, len(ne)):
        one_state = ne[i]
        sum_ = len(ne[i])
        print(one_state, "has", sum_, "letters.")
...
hourly_temp = [40.0, 39.0, 37.0, 34.0, 33.0, 34.0, 36.0, 37.0, 38.0, 39.0, \
               ...
               36.0, 35.0, 33.0, 32.0]
hourly_temp2 = [37, 40, 51, 23, 45, 10, 15, 17, 28, 30]
#%%
